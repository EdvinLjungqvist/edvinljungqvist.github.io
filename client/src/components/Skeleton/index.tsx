...
const Skeleton: FunctionComponent<SkeletonProps> = ({ type, count = 1, className = "", style = {}, baseColor = "var(--surface-10)", pulseColor = "var(--surface-20)", contentColor = "var(--surface-30)" }): ReactElement => {
    return (
        <>
